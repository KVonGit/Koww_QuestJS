...
const lang = {
  ...
  aboutScript:function() {
    metamsg("<b>{show:settings:title}</b><br/>version {show:settings:version}<br/>Based upon the original Quest 2 text adventure by {show:settings:author}<br/>Ported using QuestJS (Quest 6) version {show:settings:questVersion}.1.", {settings:settings})
