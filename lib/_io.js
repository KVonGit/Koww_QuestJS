...
io.init = function() {
  ...
  msg("THE ADVENTURES OF KOWW THE MAGICIAN<br/>QuestJS port<br/>Version {show:settings:version}<br/>Quest Text Adventures - An interactive fantasy<br/>by Brian the Great")
