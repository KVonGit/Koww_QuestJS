...
io.init = function() {
  ...
  msg("<br/><br/><br/><i>Find out if the grass is really greener on the other side of the chasm.</i><br/><br/>")
  msg("THE ADVENTURES OF KOWW THE MAGICIAN<br/>QuestJS port<br/>Version {show:settings:version}<br/>Quest Text Adventures - An interactive fantasy<br/>Based upon the original Quest 2 Text Adventure by Brian the Great")
